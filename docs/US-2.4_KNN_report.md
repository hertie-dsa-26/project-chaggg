...
| 2 | Öneri: `ruff` (veya eşdeğeri) ile statik kontrol + CI’da `ruff check` / format check | **Onay bekliyor** |
| 3 | Öneri: CI’da coverage özeti (`coverage` + `unittest`) | **Onay bekliyor** |
| 4 | Push + GitHub’da CI yeşili doğrulama | **Onay bekliyor** (push istenince) |

**Not:** Adım 2–4’ü sen “onayla / atla” dedikçe sırayla işleyeceğiz; onay vermeden bir sonraki adıma geçmeyeceğim.
