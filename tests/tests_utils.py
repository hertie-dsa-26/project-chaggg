...
from utils import combined_distance, cyclical_distance, haversine, temporal_distance
...
def test_combined_distance_spatial():
    ...
    crime2 = {"latitude": 41.8781, "longitude": -87.6298, "month": 12, "hour": 23, "day_of_week": 6}
    max_distance = 54  # rounded max distance in dataset for normalisation
    assert combined_distance(crime1, crime2, max_distance, alpha=1, beta=0) == pytest.approx(
        haversine(52.5200, 13.4050, 41.8781, -87.6298) / 54
    )
